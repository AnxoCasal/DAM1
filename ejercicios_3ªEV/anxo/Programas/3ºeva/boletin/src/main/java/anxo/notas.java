...
public class notas {
    ...
    public static void main(String[] args) {
        ...
        for (TablaNotas fuera : notas) {
            ...
            System.out.printf("%5s %5s %5s %5s %5s %5s %5s %n", "Alumno", "Asignat.", "Nota", "", "Nota", "Alumno",
                    "Asignat.");
            menor = true;
            for (TablaNotas dentro : notas) {
                System.out.printf("%5d  %5d  %5d %5s %5d %5d %5d \t" + (dentro.getNota() > fuera.getNota()) + "%n",
                        fuera.getAlumno(), fuera.getAsignatura(), fuera.getNota(), "<", dentro.getNota(),
                        dentro.getAlumno(), dentro.getAsignatura());
            ...
            if (menor)
                System.out.printf("%n ¡¡¡ Mayor nota: %d del alumno %d en la asignatura %d !!! %n", fuera.getNota(),
                        fuera.getAlumno(), fuera.getAsignatura());
        }
    }
}