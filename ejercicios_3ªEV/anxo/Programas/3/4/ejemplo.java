...
public class ejemplo {
    ...
    /**
     * Funcion al que se le pasa un string y devuelve la parte de el que se le
     * indique
     * 
    ...
    public static String subCadena(String cadena, int inicio, int cant) throws IllegalArgumentException {
        String fragmento = "";
    ...
    public static void muestraCentrado(String cadena) throws BufQueLargaException {
    ...
    /**
     * Cooncatena una serie indefinida de strings y los pasa a mayusculas y
     * convierte las _ en espacios
     * 
     * @param cadena
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            int num1 = sc.nextInt();
            int num2 = sc.nextInt();
            System.out.println(subCadena(cadena, num1, num2));
            muestraCentrado(cadena);
        } catch (BufQueLargaException e) {
            System.out.println(e.getMessage());
        } catch (IllegalArgumentException e) {
            System.out.println("Argumentos no validos");
        } catch (java.util.InputMismatchException e) {
            System.out.println("Introduzca solo numeros como indices");
        }
         ...
         * 
         * System.out.println(pasoAMayusculas("casa", "arBOl_frutal", "coche",
         * "ABCabcáéíñÑ!·$%&/ _*"));
         */
